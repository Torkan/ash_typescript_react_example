...
defmodule SeedHelpers do
  def create_or_get_user(email) do
    ...
    case AshTypescriptReactExample.Repo.get_by(AshTypescriptReactExample.Accounts.User, email: email) do
      nil ->
...
{:ok, default_company} = AshTypescriptReactExample.Invoicing.Company
...
{:ok, second_company} = AshTypescriptReactExample.Invoicing.Company
  |> Ash.Changeset.for_create(:create, %{
...
# Create customers
{:ok, customer1} = AshTypescriptReactExample.Invoicing.Customer
  |> Ash.Changeset.for_create(:create, %{
...
{:ok, customer2} = AshTypescriptReactExample.Invoicing.Customer
  |> Ash.Changeset.for_create(:create, %{
...
{:ok, customer3} = AshTypescriptReactExample.Invoicing.Customer
  |> Ash.Changeset.for_create(:create, %{
...
{:ok, draft_invoice} = AshTypescriptReactExample.Invoicing.Invoice
  |> Ash.Changeset.for_create(:create, %{
...
{:ok, _line1} = AshTypescriptReactExample.Invoicing.InvoiceLine
  |> Ash.Changeset.for_create(:create, %{
...
{:ok, _line2} = AshTypescriptReactExample.Invoicing.InvoiceLine
  |> Ash.Changeset.for_create(:create, %{
    invoice_id: draft_invoice.id,
    line_number: 2,
...
{:ok, _line3} = AshTypescriptReactExample.Invoicing.InvoiceLine
  |> Ash.Changeset.for_create(:create, %{
    invoice_id: draft_invoice.id,
    line_number: 3,
...
{:ok, finalized_invoice} = AshTypescriptReactExample.Invoicing.Invoice
  |> Ash.Changeset.for_create(:create, %{
...
{:ok, finalized_invoice} = finalized_invoice
...
{:ok, credit_note} = AshTypescriptReactExample.Invoicing.CreditNote
  |> Ash.Changeset.for_create(:create, %{
    issue_date: Date.utc_today(),
...
{:ok, _credit_line} = AshTypescriptReactExample.Invoicing.CreditNoteLine
  |> Ash.Changeset.for_create(:create, %{
...
{:ok, simple_invoice} = AshTypescriptReactExample.Invoicing.Invoice
  |> Ash.Changeset.for_create(:create, %{
...
# Add single line
{:ok, _simple_line} = AshTypescriptReactExample.Invoicing.InvoiceLine
  |> Ash.Changeset.for_create(:create, %{
