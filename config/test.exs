...
config :ash_typescript_react_example, AshTypescriptReactExample.Repo,
  ...
  password: "postgres",
  hostname: "localhost",
  database: "ash_typescript_react_example_test#{System.get_env("MIX_TEST_PARTITION")}",
...
config :ash_typescript_react_example, AshTypescriptReactExampleWeb.Endpoint,
  ...
  secret_key_base: "nwrOUASnTaIgVUex+Uh+5HHitYwj3oHu0QRgnZGfSbMD8Yptd5K0D6iZZFVpAquH",
  server: false
