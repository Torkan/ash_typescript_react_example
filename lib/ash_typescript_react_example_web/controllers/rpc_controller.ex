defmodule AshTypescriptReactExampleWeb.RpcController do
  ...
  def run(conn, params) do
    ...
    result = AshTypescript.Rpc.run_action(:ash_typescript_react_example, conn, params)
    json(conn, result)
  end

  def validate(conn, params) do
    conn = Ash.PlugHelpers.set_actor(conn, conn.assigns[:current_user])
    result = AshTypescript.Rpc.validate_action(:ash_typescript_react_example, conn, params)
    json(conn, result)
  end
end
